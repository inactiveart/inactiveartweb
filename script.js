    ...
    fetch('data.json')
        ...
        .then(data => {
            ...
            if (socialContainer && data.social) {
                ...
                if (data.social.x) {
                    html += `<a href="${data.social.x}" target="_blank" class="icon-link x-icon">
                        <svg viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                    </a>`;
                }
                if (data.social.instagram) {
                    html += `<a href="${data.social.instagram}" target="_blank" class="icon-link ig-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
                    </a>`;
                }
                if (data.social.github) {
                    html += `<a href="${data.social.github}" target="_blank" class="icon-link git-icon">
